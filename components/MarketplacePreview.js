  ...
  return (
    <section className="py-24 relative overflow-hidden" id="marketplace">
      ...
      <div className="text-center mt-8 relative z-10">
        <button className="btn-ghost border border-[var(--text-main)]/20 text-[var(--text-muted)] hover:text-[var(--primary)] hover:border-[var(--primary)]/50 hover:bg-[var(--primary)]/10 px-8 py-3 text-base group">
