      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            <div className="inline-block px-3 py-1 rounded-full bg-[var(--primary)]/10 text-[var(--primary)] text-sm font-medium mb-6 border border-[var(--primary)]/20">
          ...
          <div className="w-full lg:w-1/2">
            <div className="glass-panel rounded-xl overflow-hidden border border-white/10 shadow-2xl bg-black/40 backdrop-blur-xl">
              {/* Header */}
